...
| CallDelete | Փաստաթղթի [Delete](../../../ScriptProcs/Delete.md) իրադարձության կանչի հայտանիշ։ `True` արժեքի դեպքում [Delete](../../../ScriptProcs/Delete.md) իրադարձությունը կանչվում է։ Լռությամբ արժեքը `True` է։  |
